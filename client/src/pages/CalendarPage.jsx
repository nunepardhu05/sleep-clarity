  ...
  const handleCreateEvent = (e) => {
    ...
    if (finalStart) {
      ...
      if (finalEnd) {
        ...
        const currentTaskDates = [selectedDateStr];
        if (endMins < startMins) {
          const nextD = new Date(selectedDateStr + 'T00:00:00');
        ...
        for (const t of allTasks) {
          ...
          for (const sharedD of sharedDates) {
            const tempCurrent = { date: selectedDateStr, startTime: finalStart, endTime: finalEnd };
